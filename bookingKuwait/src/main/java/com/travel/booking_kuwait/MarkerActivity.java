...
//            }
        ...
        private void render(Marker marker, View view) {
            ...
            if (title != null) {
                ...
                titleText.setSpan(new ForegroundColorSpan(Color.parseColor("#0072BC")), 0, titleText.length(), 0);
            ...
            if (snippet != null && snippet.length() > 12) {
                ...
                snippetText.setSpan(new ForegroundColorSpan(Color.parseColor("#0072BC")), 0, 10, 0);
...
//    private final Random mRandom = new Random();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lan = getIntent().getExtras().getDouble("Langitude");

        name = getIntent().getExtras().getString("HotelName");
        address = getIntent().getExtras().getString("HotelAddress");
